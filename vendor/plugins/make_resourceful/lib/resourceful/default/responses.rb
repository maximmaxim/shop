      ...
      def self.included(base)
        base.made_resourceful do
          ...
          response_for(:show_fails) do |format|
            not_found = Proc.new { render :text => I18n.t('make_resourceful.show.fails', :default => "Не найден объект"), :status => 404 }
          ...
          response_for(:create) do |format|
            format.html do
              set_default_flash :notice, I18n.t('make_resourceful.create.success', :default => "Успешно создано!")
          ...
          response_for(:create_fails) do |format|
            format.html do
              set_default_flash :error, I18n.t('make_resourceful.create.fails', :default => "Не удалось создать!")
          ...
          response_for(:update) do |format|
            format.html do
              set_default_flash :notice, I18n.t('make_resourceful.update.success', :default => "Успешно сохранено!")
              set_default_redirect object_path
            end
            format.js
          end
          ...
          response_for(:update_fails) do |format|
            format.html do
              set_default_flash :error, I18n.t('make_resourceful.update.fails', :default => "Не получилось изменить!")
          ...
          response_for(:destroy) do |format|
            format.html do
              set_default_flash :notice, I18n.t('make_resourceful.destroy.success', :default => "Запись успешно удалена!")
          ...
          response_for(:destroy_fails) do |format|
            format.html do
              set_default_flash :error, I18n.t('make_resourceful.destroy.fails', :default => "Не получилось удалить!")
